...
export default function Reviews({ dict }: { dict: ReviewsDict }) {
  ...
  return (
    <section
      id="testimonials"
      ref={ref}
      className="px-6 py-16 md:px-8 md:py-24 xl:px-16 xl:py-32 bg-[#f8fafc]"
    >
      <div className="mx-auto max-w-6xl">
        ...
        >
          <div className="pointer-events-none absolute inset-x-0 top-0 h-24 bg-linear-to-b from-[#f8fafc] to-transparent z-10" />
          <div className="pointer-events-none absolute inset-x-0 bottom-0 h-24 bg-linear-to-t from-[#f8fafc] to-transparent z-10" />
